 ...
 useEffect(()=>{
  ...
  return (
    <Flex>
        ...
        color='gray.100' borderBottom={discountCodeError?'1px solid red':'1px solid var(--chakra-colors-gray-600)'} 
        placeholder={discountCodeError?'wrong code':'discount code'} focusBorderColor="gray.600"
