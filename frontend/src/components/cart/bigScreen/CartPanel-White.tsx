...
const CartPanelWhite = () => {
  ...
  if(isShippmentConflict){
    return(
    <Box bg='gray.100' height='100%' position='relative'  width='40%' textAlign='center'>
  ...
  return (
      <Box bg='gray.100' height='100%'  width='40%' padding={isLessWidthThan1280?'40px':'100px 70px 0 70px'}>
